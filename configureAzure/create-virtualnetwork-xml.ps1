...
$use_subnet_name = $input_subnet_name[$i]
$use_subnet_prefix = $input_subnet_prefix[$i]

echo $("            <Subnet name=" + '"' + "$use_subnet_name" + '"' + ">") >> $VNETCONF
echo $("              <AddressPrefix>" + "$use_subnet_prefix" + "</AddressPrefix>") >> $VNETCONF
